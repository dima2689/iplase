...
function ProductItem({ product, productFilter, productFilterPath }) {
    ...
    // useEffect(() => {
    //     if (String(id).includes('iphone')) {
    //         getPhoneDataById(product.id).then((data) => {
    //             if (data.success) {
    //                 const fetchedPrice = data.data.price || price;
